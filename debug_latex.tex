...
\setlength{\baselineskip}{16.799999999999997pt}
...
\makeatletter
% 定义 longtable 需要的命令（如果未定义）
\providecommand{\endhead}{}  % longtable 表头结束标记
\providecommand{\endfirsthead}{}  % longtable 第一页表头结束标记
\providecommand{\endfoot}{}  % longtable 表尾结束标记
\providecommand{\endlastfoot}{}  % longtable 最后页表尾结束标记
% 重新定义 longtable 环境为简单的 tabular
